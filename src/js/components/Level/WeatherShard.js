...
export default (props) => {
  ...
  return (
    <div className={'weather-shard weather-shard-' + props.type}>
      ...
      >
        <path
          className={'shard shard-4 ' + activeAt(0.8, percentPower, weatherVisible, overridePower)}
          fill='#CFCFCF' d='M102.4 20.3l-24-5 13.4 22 10.6-17zM141.8 37.4L132 53.7l-.2.6 23.4 4.7z'
        />
        <path
          className={'shard shard-3 ' + activeAt(0.5, percentPower, weatherVisible, overridePower)}
          fill='#AFAFAF' d='M131.2 20.3l-6.6 16 7.4 17.4 9.8-16.3 13.4-22zM103 53.8l7.3-16.7-8-16.7-10.5 17L78.4 59l24.8-5z'
        />
        <path
          className={'shard shard-2 ' + activeAt(0.3, percentPower, weatherVisible, overridePower)}
        ...
        />
        <path
          className={'shard shard-1 ' + activeAt(0.1, percentPower, weatherVisible, overridePower)}
